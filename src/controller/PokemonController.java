...
public class PokemonController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (value1 != null) {
			...
			msg = "<center>" + bulbasaur.getPokemonName() + "  #" + bulbasaur.getPokemonName();
		...
		if (value2 != null) {
			...
			msg = "<center>" + charizard.getPokemonName() + "  #" + charizard.getPokemonName();
		...
		if (value3 != null) {
			...
			msg = "<center>" + dragonite.getPokemonName() + "  #" + dragonite.getPokemonName();
			request.setAttribute("message2",dragonite.getPokemonNumber());
		...
		if (value4 != null) {
			...
			msg = "<center>" + mew.getPokemonName() + "  #" + mew.getPokemonName();
			request.setAttribute("message2",mew.getPokemonNumber());
		...
		if (value5 != null) {
			...
			msg = "<center>" + pikachu.getPokemonName() + "  #" + pikachu.getPokemonName();
			request.setAttribute("message2",pikachu.getPokemonNumber());
